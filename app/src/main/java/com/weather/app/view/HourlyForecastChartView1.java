 ...
 */
public class HourlyForecastChartView1 {
    ...
    public GraphicalView getChartGraphicalView(Context context,
        ...
        return ChartFactory.getBarChartView(context, getDataSet(titles, xValues, yValues),
                getRenderer(titles, mStrDates, yValues),
...
//        mRenderer.setPointSize(10f);//设置点的大小
        ...
        mRenderer.setYAxisMax(getMax(yValues.get(0))*1.1);
...
//        mRenderer.setLabelFormat();
        ...
        for (i = 0; i < titles.length; i++) {
            ...
            xySeriesRenderer.setColor(MyApplication.getContext().getResources()
                    .getColor(R.color.chart_bar_color));//设置颜色
            ...
            xySeriesRenderer.setChartValuesSpacing(3);//显示的点的值与图的距离
            xySeriesRenderer.setChartValuesTextSize(40);//点的值的文字大小
            xySeriesRenderer.setLineWidth(0f);//设置线宽
